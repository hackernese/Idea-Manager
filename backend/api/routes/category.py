...
def list_all_category():
    ...
    for category in categories:
        category_data = {'id': category.id, 'name': category.name, 'created_on': category.created_on}
...
def get_category_info(category_id):
    ...
    if category:
        ...
        result.append({'id': category.id, 'name': category.name, 'created_on': category.created_on})
        return jsonify({
            'status':'OK',
            'msg':result
        })
